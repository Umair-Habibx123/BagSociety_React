...
//                     className={`px-4 py-2 border-2 rounded-lg font-medium transition-colors duration-300 ${currentPage === index + 1 ? 'bg-gray-800 text-white border-gray-800' : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-100'}`}
//                   >
//                     {index + 1}
//                   </button>
//                 </li>
