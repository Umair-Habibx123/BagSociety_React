      ...
      <div className="container mx-auto px-4 sm:px-8 lg:px-16">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-700">
            Welcome to <strong>Bag Society</strong>, your trusted destination
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-gray-700 text-lg mb-4">
              At <strong>Bag Society</strong>, we believe that every product
        ...
        <div className="mt-10 text-center">
          ...
          <p className="text-gray-700 text-lg">
            ...
            something you’ll love at <strong>Bag Society</strong>.
          </p>
        </div>
        ...
        <div className="mt-10 text-center">
          ...
          <ul className="space-y-3 text-gray-700 text-lg">
            <li>
              <strong>WhatsApp:</strong> +92-310-8026280
            </li>
            <li>
              <strong>Email:</strong>{" "}
              <a
                href="mailto:bagsociety786@gmail.com"
            ...
            <li>
              ...
              <a
                href="https://bagsociety.vercel.app/"
                className="text-blue-600 hover:underline"
              >
                https://bagsociety.vercel.app/
              </a>
            </li>
          </ul>
        </div>
